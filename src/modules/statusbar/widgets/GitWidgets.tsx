  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side="top">
        {detached ? `Detached HEAD at ${branch}` : `On branch ${branch}`}
      </TooltipContent>
    </Tooltip>
  );
}
...
export function GitSyncWidget({ ctx }: { ctx: StatusbarWidgetCtx }) {
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side="top">{indicator.title}</TooltipContent>
    </Tooltip>
  );
}
...
export function LineChangesWidget({ ctx }: { ctx: StatusbarWidgetCtx }) {
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side="top">
        {`${insertions} insertions, ${deletions} deletions vs HEAD (tracked files)`}
      </TooltipContent>
    </Tooltip>
  );
}
